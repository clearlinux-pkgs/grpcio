...
Source0  : https://files.pythonhosted.org/packages/0b/f2/b14091fd31bfced105d8352f46bbc495518a93ff0debcc7db283258ad655/grpcio-1.41.0.tar.gz
...
%prep
%setup -q -n grpcio-1.41.0
cd %{_builddir}/grpcio-1.41.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632785857
...
cp %{_builddir}/grpcio-1.41.0/LICENSE %{buildroot}/usr/share/package-licenses/grpcio/2b8b815229aa8a61e483fb4ba0588b8b6c491890
