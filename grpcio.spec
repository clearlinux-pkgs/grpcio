...
Source0  : https://files.pythonhosted.org/packages/8c/34/7dafc9052bd9b2b41c5a8912aeeca01e179d16de17e9c275633d4b807330/grpcio-1.38.0.tar.gz
...
%prep
%setup -q -n grpcio-1.38.0
cd %{_builddir}/grpcio-1.38.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1621557480
...
cp %{_builddir}/grpcio-1.38.0/LICENSE %{buildroot}/usr/share/package-licenses/grpcio/2b8b815229aa8a61e483fb4ba0588b8b6c491890
