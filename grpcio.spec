...
Source0  : https://files.pythonhosted.org/packages/5e/29/1bd649737e427a6bb850174293b4f2b72ab80dd49462142db9b81e1e5c7b/grpcio-1.30.0.tar.gz
...
%prep
%setup -q -n grpcio-1.30.0
cd %{_builddir}/grpcio-1.30.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1592936148
...
cp %{_builddir}/grpcio-1.30.0/LICENSE %{buildroot}/usr/share/package-licenses/grpcio/2b8b815229aa8a61e483fb4ba0588b8b6c491890
