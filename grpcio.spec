...
Version  : 1.34.0
Release  : 54
URL      : https://files.pythonhosted.org/packages/35/98/74a430566fdd9d4cc0386322e55306c8928a95da95b1da6fba08641526b5/grpcio-1.34.0.tar.gz
...
%prep
%setup -q -n grpcio-1.34.0
cd %{_builddir}/grpcio-1.34.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1607012560
...
cp %{_builddir}/grpcio-1.34.0/LICENSE %{buildroot}/usr/share/package-licenses/grpcio/2b8b815229aa8a61e483fb4ba0588b8b6c491890
