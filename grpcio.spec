...
%prep
%setup -q -n grpcio-1.35.0
cd %{_builddir}/grpcio-1.35.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611425976
...
cp %{_builddir}/grpcio-1.35.0/LICENSE %{buildroot}/usr/share/package-licenses/grpcio/2b8b815229aa8a61e483fb4ba0588b8b6c491890
