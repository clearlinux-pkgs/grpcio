...
Source0  : https://files.pythonhosted.org/packages/07/ea/398472e896f529d23fb58e33f01298dfc554a341d58f87c1ea5ad817208e/grpcio-1.39.0.tar.gz
...
%prep
%setup -q -n grpcio-1.39.0
cd %{_builddir}/grpcio-1.39.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1626965840
...
cp %{_builddir}/grpcio-1.39.0/LICENSE %{buildroot}/usr/share/package-licenses/grpcio/2b8b815229aa8a61e483fb4ba0588b8b6c491890
