...
Version  : 1.25.0
Release  : 37
URL      : https://files.pythonhosted.org/packages/e4/60/40c4d2b61d9e4349bc89445deb8d04cc000b10a63446c42d311e0d21d127/grpcio-1.25.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/e4/60/40c4d2b61d9e4349bc89445deb8d04cc000b10a63446c42d311e0d21d127/grpcio-1.25.0.tar.gz
...
%prep
%setup -q -n grpcio-1.25.0
cd %{_builddir}/grpcio-1.25.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1575559749
...
cp %{_builddir}/grpcio-1.25.0/LICENSE %{buildroot}/usr/share/package-licenses/grpcio/2b8b815229aa8a61e483fb4ba0588b8b6c491890
