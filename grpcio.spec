...
Source0  : https://files.pythonhosted.org/packages/f1/23/62d3e82fa4c505f3195315c8a774b2e656b556d174329aa98edb829e48bc/grpcio-1.29.0.tar.gz
...
%prep
%setup -q -n grpcio-1.29.0
cd %{_builddir}/grpcio-1.29.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1589492580
...
cp %{_builddir}/grpcio-1.29.0/LICENSE %{buildroot}/usr/share/package-licenses/grpcio/2b8b815229aa8a61e483fb4ba0588b8b6c491890
