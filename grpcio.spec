...
%prep
%setup -q -n grpcio-1.27.2
cd %{_builddir}/grpcio-1.27.2
...
cp %{_builddir}/grpcio-1.27.2/LICENSE %{buildroot}/usr/share/package-licenses/grpcio/2b8b815229aa8a61e483fb4ba0588b8b6c491890
