...
Source0  : https://files.pythonhosted.org/packages/81/5e/168a7fa23a025beed6b7daa0981ace55e394a136db3082faed7d6cba4556/grpcio-1.34.1.tar.gz
...
%prep
%setup -q -n grpcio-1.34.1
cd %{_builddir}/grpcio-1.34.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610577516
...
cp %{_builddir}/grpcio-1.34.1/LICENSE %{buildroot}/usr/share/package-licenses/grpcio/2b8b815229aa8a61e483fb4ba0588b8b6c491890
