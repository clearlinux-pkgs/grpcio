...
Source0  : https://files.pythonhosted.org/packages/cd/80/4b65b06e35599af065076891248b88d16c87cee1121b8886316ad4343f50/grpcio-1.38.1.tar.gz
...
%prep
%setup -q -n grpcio-1.38.1
cd %{_builddir}/grpcio-1.38.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1624372682
...
cp %{_builddir}/grpcio-1.38.1/LICENSE %{buildroot}/usr/share/package-licenses/grpcio/2b8b815229aa8a61e483fb4ba0588b8b6c491890
