...
Source0  : https://files.pythonhosted.org/packages/46/49/aa254d395a594245cfa6c5c09eb5cf278edb9847babdb88efebba1ca86e4/grpcio-1.36.1.tar.gz
...
%prep
%setup -q -n grpcio-1.36.1
cd %{_builddir}/grpcio-1.36.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1614873078
...
cp %{_builddir}/grpcio-1.36.1/LICENSE %{buildroot}/usr/share/package-licenses/grpcio/2b8b815229aa8a61e483fb4ba0588b8b6c491890
