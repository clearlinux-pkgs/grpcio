...
Source0  : https://files.pythonhosted.org/packages/a0/d6/d04c6550debe23e2eaef0d9c4adccbb6e20d8cce6da40ae989fe8836e287/grpcio-1.37.1.tar.gz
...
%prep
%setup -q -n grpcio-1.37.1
cd %{_builddir}/grpcio-1.37.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619790272
...
cp %{_builddir}/grpcio-1.37.1/LICENSE %{buildroot}/usr/share/package-licenses/grpcio/2b8b815229aa8a61e483fb4ba0588b8b6c491890
