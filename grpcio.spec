...
Source0  : https://files.pythonhosted.org/packages/34/be/2565634fc96213bd761ad5732459ab5667ac12b249ccd8c4e658c4e70b99/grpcio-1.42.0.tar.gz
...
%prep
%setup -q -n grpcio-1.42.0
cd %{_builddir}/grpcio-1.42.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1637195883
...
cp %{_builddir}/grpcio-1.42.0/LICENSE %{buildroot}/usr/share/package-licenses/grpcio/34ac89724cb7e3fb36bcfe93efabfd012c569a0e
