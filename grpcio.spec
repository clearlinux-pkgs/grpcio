...
Version  : 1.36.0
Release  : 59
URL      : https://files.pythonhosted.org/packages/9d/9e/18e92a4042fdee8613f5613a37cf7162d32b5674f1b12d0f7b042e7e710b/grpcio-1.36.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/9d/9e/18e92a4042fdee8613f5613a37cf7162d32b5674f1b12d0f7b042e7e710b/grpcio-1.36.0.tar.gz
...
%prep
%setup -q -n grpcio-1.36.0
cd %{_builddir}/grpcio-1.36.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1614610452
...
cp %{_builddir}/grpcio-1.36.0/LICENSE %{buildroot}/usr/share/package-licenses/grpcio/2b8b815229aa8a61e483fb4ba0588b8b6c491890
